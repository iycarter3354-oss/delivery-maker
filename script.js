...
function addRow() {
  ...
  tr.innerHTML = `
    <td><input type="text" class="item-name" placeholder="品名" /></td>
...
function update() {
  ...
  bind('p-deliveryNo',    document.getElementById('deliveryNo').value);
...
['senderName','senderAddress','senderPhone','senderEmail','clientName','clientPerson','deliveryNo','issueDate','deliveryDate','notes']
